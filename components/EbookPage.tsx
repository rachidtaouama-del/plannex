                ...
                <div className="max-w-6xl mx-auto">
                    <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
                        <div className="space-y-8">
                            ...
                            <h1 className="text-5xl md:text-7xl font-black text-white tracking-tighter uppercase leading-tight">
                                Master the <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-cyan-400 to-blue-500 shadow-emerald-500/20">Critical Path</span>
                            </h1>
                            <p className="text-xl text-slate-400 leading-relaxed font-light">
                                Discover advanced strategies to cut your technical shutdown delays in half through predictive planning.
                            </p>
                            ...
                            <div className="pt-8 border-t border-white/5 flex items-center gap-8 opacity-60">
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-[10px] uppercase tracking-widest text-slate-500">Expert Pages</span>
                                </div>
                                <div className="flex flex-col">
                                    <span className="text-white font-black text-xl">PDF</span>
                                    <span className="text-[10px] uppercase tracking-widest text-slate-500">High Quality Format</span>
                                </div>
                                <div className="flex flex-col">
                                    <span className="text-white font-black text-xl">2.4MB</span>
                                    <span className="text-[10px] uppercase tracking-widest text-slate-500">File Size</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="relative aspect-[3/4] bg-slate-900 border border-white/10 rounded-[1.5rem] overflow-hidden shadow-2xl rotate-y-[-10deg] rotate-x-[5deg] group-hover:rotate-0 transition-transform duration-700 ease-out">
                                ...
                                <div className="absolute top-0 left-0 w-full h-full p-12 flex flex-col justify-between">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <p className="text-slate-400 text-sm font-medium">AI applied to heavy maintenance logistics.</p>
                    ...
                    <div id="details" className="grid lg:grid-cols-12 gap-16 items-start pt-24 border-t border-white/5">
                        <div className="lg:col-span-4 lg:sticky lg:top-32 space-y-6">
                            <HCard title="In This eBook" titleColor="blue">
                                <ul className="space-y-4">
                                    {[
                                        "The anatomy of an industrial delay",
                                        "Critical path calculation v3.0",
                                        "Co-activity optimization",
                                        "Managing the unexpected with AI",
                            ...
                            <div className="p-8 rounded-3xl bg-emerald-500/5 border border-emerald-500/10 text-center">
                                ...
                                <p className="text-white font-bold mb-2 uppercase tracking-tight">Objective: Zero Drift</p>
                                <p className="text-slate-400 text-xs leading-relaxed">
                                    A proven methodology across more than 150 major worksites in 2025.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-8 space-y-16">
                            <section>
                                <h2 className="text-4xl font-black text-white mb-8 uppercase tracking-tight">
                                    Why <span className="text-emerald-400">traditional</span> planning fails.
                                </h2>
                                <p className="text-lg text-slate-300 leading-relaxed mb-6">
                                    In heavy industry, a 24-hour delay can cost millions of dollars. Yet 70% of technical shutdowns fail to meet their initial schedule. This eBook analyzes the root causes of these drifts and proposes a radically new approach: the <strong>Dynamic Critical Path</strong>.
                                </p>
                                <div className="grid sm:grid-cols-2 gap-8 mt-12">
                                    <div className="p-6 rounded-2xl bg-[#080808] border border-white/5 hover:border-emerald-500/20 transition-all">
                                        ...
                                        <h3 className="text-white font-black uppercase tracking-widest text-sm mb-3">AI Reactivity</h3>
                                        <p className="text-slate-500 text-[13px] leading-relaxed">Learn how our algorithms recalculate priorities in milliseconds when facing field contingencies.</p>
                                    </div>
                                    <div className="p-6 rounded-2xl bg-[#080808] border border-white/5 hover:border-blue-500/20 transition-all">
                                        ...
                                        <h3 className="text-white font-black uppercase tracking-widest text-sm mb-3">Risk Management</h3>
                                        <p className="text-slate-500 text-[13px] leading-relaxed">Isolate high-criticality tasks and secure key resources before conflict arises.</p>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section>
                                <HCard>
                                    <div className="space-y-6">
                                        <h3 className="text-2xl font-black text-white uppercase tracking-tighter">Instant Access to Knowledge</h3>
                                        <p className="text-slate-400 leading-relaxed">
                                            This document is a compilation of lessons learned from project managers, planners, and methods engineers. No abstract theory, only concrete planning engineering.
                                        </p>
                                        <div className="pt-4">
                                            <a
                                                href="https://media.rachidtaouama.com/wp-content/uploads/2026/03/PlanneX_Ebook.pdf"
